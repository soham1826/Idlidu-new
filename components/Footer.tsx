...
function Footer({}: Props) {
  ...
  const itemData = [
    ...
    ["Support", "Help Center", "Cancellation options", "Safety information", "Report a concern"],
    ["Community", "Newsroom", "Learn about new features", "Letter from our founders", "Careers", "Investors"],
    ["Contact us","Explore Performances","Safety information","How to Interact with Artists"],
  ];
