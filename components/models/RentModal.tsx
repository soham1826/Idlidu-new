    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Show users your skill"
        />
        <ImageUpload
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="How would you best describe your Performance and Yourself"
        />
        <Input
          id="title"
          label="Title"
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="How much do you charge per event"
        />
        <Input
          id="price"
          label="Price"
